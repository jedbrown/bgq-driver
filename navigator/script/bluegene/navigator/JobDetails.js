...
var b_navigator_JobDetails = d_declare( [ l_EventsMonitorMixin ],

/** @lends bluegene^navigator^JobDetails# */
{
    _bgws: null,
    ...
    /**
     *  @class Stuff for the Job Details section.
     *  @constructs
     */
