...
DefaultControlEventListener* DefaultControlEventListener::_instance = NULL;

DefaultControlEventListener*
DefaultControlEventListener::getDefaultControlEventListener()
{
    if (_instance == NULL)
        _instance = new DefaultControlEventListener;
    return _instance;
}
...
int
DefaultControlEventListener::processRASMessage(
        RasEvent& rasEvent
        )
{
