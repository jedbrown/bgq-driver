...
void
GenSmallBlock::execute(deque<string> args,
                     ...
                     std::vector<std::string>* validnames)
{
    ...
    case BGQDB::DUPLICATE:
        ...
        break;
    default:
        reply << mmcs_client::FAIL << "unexpected return code from BGQDB::genSmallBlock : " << result << mmcs_client::DONE;
    break;
    }
}

void
GenSmallBlock::help(deque<string> args,
                      mmcs_client::CommandReply& reply)
{
