...
void
GenMidplaneBlock::execute(deque<string> args,
                       ...
                       std::vector<std::string>* validnames)
{
    ...
    break;
    default:
    reply << mmcs_client::FAIL << "unexpected return code from BGQDB::genBPBlock : " << result << mmcs_client::DONE;
    break;
    }
}

void
GenMidplaneBlock::help(deque<string> args,
                    mmcs_client::CommandReply& reply)
{
