...
#ifndef BLOCKCONTROLLERNODEINFO_HEADER
#define BLOCKCONTROLLERNODEINFO_HEADER
...
public:
    ...
    string nodeCardLocation() { return midplaneNodeConfig()->nodeCardLocation(_pos.nodeCard()); }
