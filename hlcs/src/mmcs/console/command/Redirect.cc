        ...
        )
{
    ...
    if (args[1] == "on")
    {
        ...
        boost::shared_ptr<RedirectMonitorThread::RedirectParms> parms(
                new RedirectMonitorThread::RedirectParms(pController, args[0], &reply)
                );
    ...
    else if (args[1] == "off")
    {
        if (RedirectMonitorThread::redirectMonitorThread != NULL)
        {
            ...
            boost::shared_ptr<RedirectMonitorThread::RedirectParms> p;
