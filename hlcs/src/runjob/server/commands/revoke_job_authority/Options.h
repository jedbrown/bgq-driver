...
#ifndef RUNJOB_SERVER_COMMANDS_REVOKE_JOB_AUTHORITY_OPTIONS_H
#define RUNJOB_SERVER_COMMANDS_REVOKE_JOB_AUTHORITY_OPTIONS_H
...
/*!
 * \brief Program options specific to the revoke_job_authority command.
 */
