...
#ifndef RUNJOB_SERVER_COMMANDS_REFRESH_CONFIG_OPTIONS_H
#define RUNJOB_SERVER_COMMANDS_REFRESH_CONFIG_OPTIONS_H
...
/*!
 * \brief Program options specific to the runjob_server_refresh_config command.
 */
...
private:
     ...
     * \brief
     */
    const char* description() const { return "refresh the Blue Gene runjob server configuration."; }
