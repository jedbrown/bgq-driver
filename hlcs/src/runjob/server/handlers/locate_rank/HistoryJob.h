...
#ifndef RUNJOB_SERVER_HANDLERS_LOCATE_RANK_HISTORY_JOB_H
#define RUNJOB_SERVER_HANDLERS_LOCATE_RANK_HISTORY_JOB_H
...
/*!
 * \brief Query a job in the bgqjob_history table.
 */
class HistoryJob : public Job
{
public:
    /*!
     * \brief ctor.
