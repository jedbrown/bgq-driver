...
EndTool::EndTool(
    ...
    _request(),
    _response( new runjob::commands::response::EndTool ),
    _connection()
{
...
{
    _request = boost::static_pointer_cast<runjob::commands::request::EndTool>( request );
        ...
        )
{
    ...
    if ( _connection->getUserType() == bgq::utility::portConfig::UserType::Administrator ) {
        ...
        // ending a tool requires execute authority
    ...
    job::tool::End::create( job, _request, _connection );
}
