...
#ifndef REALTIME_SERVER_DB2_TABLE_NODE_H_
#define REALTIME_SERVER_DB2_TABLE_NODE_H_
...
class Node : public AbstractTable
{
public:

    static const std::string& getTableNameUc()  { static std::string table_name_uc("TBGQNODE"); return table_name_uc; };
