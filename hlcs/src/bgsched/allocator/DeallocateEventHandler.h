...
#ifndef BGSCHED_ALLOCATOR_DEALLOCATE_EVENT_HANDLER_H_
#define BGSCHED_ALLOCATOR_DEALLOCATE_EVENT_HANDLER_H_

/*!
 *  \file bgsched/allocator/DeallocateEventHandler.h
 *  \brief Class DeallocateEventHandler.
 */
...
/*!
 *  \brief Handle compute block status changes as a result of a block deallocate.
 */
class DeallocateEventHandler: public bgsched::realtime::ClientEventListener
{
public:
    ...
    /*!
     *  \brief Handle a compute block state changed real-time event.
     */
