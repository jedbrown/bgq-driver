...
#ifndef _BGMASTERAGENTPROTOCOL_H
#define _BGMASTERAGENTPROTOCOL_H

#include "BGMasterProtocol.h"

class BGMasterAgentProtocol;

typedef boost::shared_ptr<BGMasterAgentProtocol> BGMasterAgentProtocolPtr;

//! \brief Basic BGMaster Protocol object for agent communications.  
class BGMasterAgentProtocol: public BGMasterProtocol
{
public:
    BGMasterAgentProtocol(bgq::utility::Properties::Ptr p) : BGMasterProtocol(p) {}
   ~BGMasterAgentProtocol() { }
