...
#ifndef  _KERNEL_KLINUX_COLLECTIVE_IMPL_H_
#define  _KERNEL_KLINUX_COLLECTIVE_IMPL_H_

/**
 * \file klinux/collective_impl.h
 *
 * \brief C Header File containing the implementation of the Collective SPIs
...
#endif /* _KERNEL_KLINUX_COLLECTIVE_IMPL_H_ */
