...
set my_app_floor /ltmp/tmusta/bgq.firmware.5.29.2009/bgq/work
set my_app       takeCPU.elf
set my_pers      takeCPU.elf.t1/takeCPU.elf.t1.pers
set my_ttype     fwddr
set my_num_cores 1
set my_firmware  $my_app_floor/firmware/bin/bgq_firmware.elf
