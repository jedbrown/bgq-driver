...
set my_app_floor /ltmp/tmusta/bgq.firmware.5.26.2009/bgq/work
set my_app       hello.elf
set my_pers      hello.elf.t1/hello.elf.t1.pers
set my_ttype     fwext
set my_num_cores 1
set my_firmware  /ltmp/tmusta/bgq.firmware.5.26.2009/bgq/firmware/tests/hello/hello.elf
...
source /ltmp/tmusta/debug_tools.tcl
