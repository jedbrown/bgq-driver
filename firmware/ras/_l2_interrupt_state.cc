...
/* end_generated_IBM_copyright_prolog                               */
  ...
  const std::string          COH_CE_DESCR = " [COH_CE] Coherence array correctable error";
  const std::string          COH_UE_DESCR = " [COH_UE] Coherence array uncorrectable error";
  const std::string         DIRB_CE_DESCR = " [DIRB_CE] Directory array correctable error";
  const std::string         DIRB_UE_DESCR = " [DIRB_UE] Directory array uncorrectable error";
  const std::string          EDR_CE_DESCR = " [EDR_CE] Coherence array correctable error";
  const std::string         EDR_OCE_DESCR = " [EDR_OCE] Coherence array correctable error";
  const std::string         EDR_OUE_DESCR = " [EDR_OUE] Coherence array correctable error";
  const std::string          EDR_UE_DESCR = " [EDR_UE] Coherence array ucorrectable error";
  const std::string          LRU_CE_DESCR = " [LRU_CE] LRU correctable error";
  const std::string          LRU_UE_DESCR = " [LRU_UE] LRU uncorrectable error";
  const std::string          SPR_CE_DESCR = " [SPR_CE] SPR correctable error";
  const std::string          SPR_UE_DESCR = " [SPR_UE] SPR uncorrectable error";
  const std::string           RQ_CE_DESCR = " [RQ_CE] Read queue correctable error";
  const std::string           RQ_UE_DESCR = " [RQ_UE] Read queue uncorrectable error";
