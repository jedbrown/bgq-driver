...
#ifndef _ELF32FILE_H_
#define _ELF32FILE_H_
...
public:
    ...
    */
    ...
    //
    */
    const Elf32_Shdr *GetSectionHeader(int nSection,
    ...
    */
    ...
    /////////////////////////////////////////////////////////////
    // const Elf32_Phdr *GetProgramHeader(int nHeader);
    /*!
    ...
    //
    */
    const Elf32_Phdr *GetProgramHeader(int nHeader) const;
    ...
    //
    */
    const Elf32_Phdr *GetProgramHeader(const Elf32_Shdr *pSectHdr) const;
...
private:
    ...
    Elf32_Ehdr m_ElfFileHdr;

    // elf data encoding big endian or little endian
    int m_nDataType;    // ELFDATA2LSB or ELFDATA2MSB

    std::vector<Elf32_Phdr> m_vectProgramHeaders;
    std::vector<Elf32_Shdr> m_vectSectionHeaders;
