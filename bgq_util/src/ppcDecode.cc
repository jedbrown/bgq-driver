...
/* Opcode is supported by BlueGene/L and BlueGene/P */
#define PPC_OPCODE_BGL           0x1000000
 
/* Opcode is supported by PowerPC/450 */
#define PPC_OPCODE_450           0x2000000
...
#define MO MB6 + 1
 ...
 /* The TH field in a dcbtstep instruction. */
#define TH MO + 1
  { 5, 21, NULL, NULL, PPC_OPERAND_OPTIONAL },
...
/* The mask for an X form instruction with the literal field. */
...
/* Set to COM for easy implementation initially, change to its own
   value when moving to binutils 2.18. */
#define POWERA2 COM                
...
#define PPCBGL          PPC_OPCODE_BGL
/* Set to COM for easy inital implementation, change to its own value
   when adding to binutils 2.18. */
#define PPCQPX		COM
#define PPCA2           COM
//
/* The opcode table.
...
{ "fpsel",    A(0,5,0),   A_MASK,        PPCBGL, { FRT, FRA, FRC, FRB }},
{ "fpmul",    A(0,8,0),   AFRB_MASK,     PPCBGL, { FRT, FRA, FRC } },
{ "fxmul",    A(0,9,0),   AFRB_MASK,     PPCBGL, { FRT, FRA, FRC } },
{ "fxpmul",   A(0,10,0),  AFRB_MASK,     PPCBGL, { FRT, FRA, FRC } },
{ "fxsmul",   A(0,11,0),  AFRB_MASK,     PPCBGL, { FRT, FRA, FRC } },
{ "fpadd",    A(0,12,0),  AFRC_MASK,     PPCBGL, { FRT, FRA, FRB } },
{ "fpsub",    A(0,13,0),  AFRC_MASK,     PPCBGL, { FRT, FRA, FRB } },
{ "fpre",     A(0,14,0),  AFRAFRC_MASK,  PPCBGL, { FRT, FRB } },
{ "fprsqrte", A(0,15,0),  AFRAFRC_MASK,  PPCBGL, { FRT, FRB } },
{ "fpmadd",   A(0,16,0),  A_MASK,        PPCBGL, { FRT, FRA, FRC, FRB }},
{ "fxmadd",   A(0,17,0),  A_MASK,        PPCBGL, { FRT, FRA, FRC, FRB }},
{ "fxcpmadd", A(0,18,0),  A_MASK,        PPCBGL, { FRT, FRA, FRC, FRB }},
{ "fxcsmadd", A(0,19,0),  A_MASK,        PPCBGL, { FRT, FRA, FRC, FRB }},
{ "fpnmadd",  A(0,20,0),  A_MASK,        PPCBGL, { FRT, FRA, FRC, FRB }},
{ "fxnmadd",  A(0,21,0),  A_MASK,        PPCBGL, { FRT, FRA, FRC, FRB }},
{ "fxcpnmadd",A(0,22,0),  A_MASK,        PPCBGL, { FRT, FRA, FRC, FRB }},
{ "fxcsnmadd",A(0,23,0),  A_MASK,        PPCBGL, { FRT, FRA, FRC, FRB }},
{ "fpmsub",   A(0,24,0),  A_MASK,        PPCBGL, { FRT, FRA, FRC, FRB }},
{ "fxmsub",   A(0,25,0),  A_MASK,        PPCBGL, { FRT, FRA, FRC, FRB }},
{ "fxcpmsub", A(0,26,0),  A_MASK,        PPCBGL, { FRT, FRA, FRC, FRB }},
{ "fxcsmsub", A(0,27,0),  A_MASK,        PPCBGL, { FRT, FRA, FRC, FRB }},
{ "fpnmsub",  A(0,28,0),  A_MASK,        PPCBGL, { FRT, FRA, FRC, FRB }},
{ "fxnmsub",  A(0,29,0),  A_MASK,        PPCBGL, { FRT, FRA, FRC, FRB }},
{ "fxcpnmsub",A(0,30,0),  A_MASK,        PPCBGL, { FRT, FRA, FRC, FRB }},
{ "fxcsnmsub",A(0,31,0),  A_MASK,        PPCBGL, { FRT, FRA, FRC, FRB }},
{ "fpmr",     X(0,32),    XRA_MASK,      PPCBGL, { FRT, FRB } },
{ "fpabs",    X(0,96),    XRA_MASK,      PPCBGL, { FRT, FRB } },
{ "fpneg",    X(0,160),   XRA_MASK,      PPCBGL, { FRT, FRB } },
{ "fprsp",    X(0,192),   XRA_MASK,      PPCBGL, { FRT, FRB } },
{ "fpnabs",   X(0,224),   XRA_MASK,      PPCBGL, { FRT, FRB } },
{ "fsmr",     X(0,288),   XRA_MASK,      PPCBGL, { FRT, FRB } },
{ "fscmp",    X(0,320),   X_MASK|(3<<21),PPCBGL, { BF, FRA, FRB } },
{ "fsabs",    X(0,352),   XRA_MASK,      PPCBGL, { FRT, FRB } },
{ "fsneg",    X(0,416),   XRA_MASK,      PPCBGL, { FRT, FRB } },
{ "fsnabs",   X(0,480),   XRA_MASK,      PPCBGL, { FRT, FRB } },
{ "fxmr",     X(0,544),   XRA_MASK,      PPCBGL, { FRT, FRB } },
{ "fpctiw",   X(0,576),   XRA_MASK,      PPCBGL, { FRT, FRB } },
{ "fpctiwz",  X(0,704),   XRA_MASK,      PPCBGL, { FRT, FRB } },
{ "fsmtp",    X(0,800),   XRA_MASK,      PPCBGL, { FRT, FRB } },
{ "fsmfp",    X(0,928),   XRA_MASK,      PPCBGL, { FRT, FRB } },

{ "attn",    X(0,256), X_MASK,		POWER4,		{ 0 } },

#define QPX 1 // enable QPX instructions

#if QPX
   // - change COM to something qpx-specific
   // - these may need to be sorted by opcode with all the other (non-qpx) instructions
   //   to avoid breaking the disassembler
   //
   ...
   {"qvfxxmadds",   A(0, 1,0),        A_MASK, PPCQPX, { QRT, QRA, QRC, QRB } },
   {"qvfxxcpnmadds",A(0, 3,0),        A_MASK, PPCQPX, { QRT, QRA, QRC, QRB } },

   {"qvfxmadds",    A(0, 9,0),        A_MASK, PPCQPX, { QRT, QRA, QRC, QRB } },
   {"qvfxxnpmadds", A(0,11,0),        A_MASK, PPCQPX, { QRT, QRA, QRC, QRB } },
   
   {"qvfxmuls",    A(0,17,0),     AFRB_MASK, PPCQPX, { QRT, QRA,      QRC } },
   {"qvfsubs",     A(0,20,0),     AFRC_MASK, PPCQPX, { QRT, QRA, QRB      } },
   {"qvfadds",     A(0,21,0),     AFRC_MASK, PPCQPX, { QRT, QRA, QRB      } },
   {"qvfres",      A(0,24,0),  AFRAFRC_MASK, PPCQPX, { QRT,      QRB      } },
   {"qvfmuls",     A(0,25,0),     AFRB_MASK, PPCQPX, { QRT, QRA,      QRC } },
   {"qvfrsqrtes",  A(0,26,0),  AFRAFRC_MASK, PPCQPX, { QRT,      QRB      } },
   {"qvfmsubs",    A(0,28,0),        A_MASK, PPCQPX, { QRT, QRA, QRC, QRB } },
   {"qvfmadds",    A(0,29,0),        A_MASK, PPCQPX, { QRT, QRA, QRC, QRB } },
   {"qvfnmsubs",   A(0,30,0),        A_MASK, PPCQPX, { QRT, QRA, QRC, QRB } },
   {"qvfnmadds",   A(0,31,0),        A_MASK, PPCQPX, { QRT, QRA, QRC, QRB } },
   {"qvfcfids",   XRC(0,846,0),    XRA_MASK, PPCQPX, { QRT,      QRB      } },
   {"qvfcfidus",  XRC(0,974,0),   XRA_MASK, PPCQPX, { QRT,      QRB      } },
...
#if QPX
   {"qvfxxmadd",    A(4, 1,0),        A_MASK, PPCQPX, { QRT, QRA, QRC, QRB } },
   {"qvfxxcpnmadd", A(4, 3,0),        A_MASK, PPCQPX, { QRT, QRA, QRC, QRB } },
   {"qvfxmadd",     A(4, 9,0),        A_MASK, PPCQPX, { QRT, QRA, QRC, QRB } },
   {"qvfxxnpmadd",  A(4,11,0),        A_MASK, PPCQPX, { QRT, QRA, QRC, QRB } },
   {"qvfsel",       A(4,23,0),        A_MASK, PPCQPX, { QRT, QRA, QRC, QRB } },
   
   {"qvfcpsgn",    A(4, 8,0),     AFRC_MASK, PPCQPX, { QRT, QRA, QRB      } },
   {"qvfxmul",     A(4,17,0),     AFRB_MASK, PPCQPX, { QRT, QRA,      QRC } },
   {"qvfsub",      A(4,20,0),     AFRC_MASK, PPCQPX, { QRT, QRA, QRB      } },
   {"qvfadd",      A(4,21,0),     AFRC_MASK, PPCQPX, { QRT, QRA, QRB      } },
   {"qvfre",       A(4,24,0),  AFRAFRC_MASK, PPCQPX, { QRT,      QRB      } },
   {"qvfmul",      A(4,25,0),     AFRB_MASK, PPCQPX, { QRT, QRA,      QRC } },
   {"qvfrsqrte",   A(4,26,0),  AFRAFRC_MASK, PPCQPX, { QRT,      QRB      } },
   {"qvfmsub",     A(4,28,0),        A_MASK, PPCQPX, { QRT, QRA, QRC, QRB } },
   {"qvfmadd",     A(4,29,0),        A_MASK, PPCQPX, { QRT, QRA, QRC, QRB } },
   {"qvfnmsub",    A(4,30,0),        A_MASK, PPCQPX, { QRT, QRA, QRC, QRB } },
   {"qvfnmadd",    A(4,31,0),        A_MASK, PPCQPX, { QRT, QRA, QRC, QRB } },
// note: qvfperm has a different operand order than other 4 operand instructions
   {"qvfperm",     A(4, 6,0),        A_MASK, PPCQPX, { QRT, QRA, QRB, QRC } },
   
   { "qvftstnan",  XO(4, 64,0,0),   XO_MASK, PPCQPX, { QRT, QRA, QRB      } },
   { "qvfcmpgt",   XO(4, 32,0,0),   XO_MASK, PPCQPX, { QRT, QRA, QRB      } },
   { "qvfcmplt",   XO(4, 96,0,0),   XO_MASK, PPCQPX, { QRT, QRA, QRB      } },
   { "qvfcmpeq",   XO(4,  0,0,0),   XO_MASK, PPCQPX, { QRT, QRA, QRB      } },

   { "qvaligni_00",  XRC(4,0x005,0),  X_MASK, PPCQPX, { QRT, QRA, QRB      } },
   { "qvaligni_01",  XRC(4,0x105,0),  X_MASK, PPCQPX, { QRT, QRA, QRB      } },
   { "qvaligni_10",  XRC(4,0x205,0),  X_MASK, PPCQPX, { QRT, QRA, QRB      } },
   { "qvaligni_11",  XRC(4,0x305,0),  X_MASK, PPCQPX, { QRT, QRA, QRB      } },
   { "qvaligni",     XRC(4,0x05,0), XLIT_MASK, PPCQPX, { QRT, QRA, QRB, QVD } },

   { "qvesplati_00", XRC(4,0x025,0),XRB_MASK, PPCQPX, { QRT, QRA           } },
   { "qvesplati_01", XRC(4,0x125,0),XRB_MASK, PPCQPX, { QRT, QRA           } },
   { "qvesplati_10", XRC(4,0x225,0),XRB_MASK, PPCQPX, { QRT, QRA           } },
   { "qvesplati_11", XRC(4,0x325,0),XRB_MASK, PPCQPX, { QRT, QRA           } },
   { "qvesplati",    XRC(4,0x25,0),XLIT_MASK, PPCQPX, { QRT, QRA,      QVD } },
   
   { "qvgpci",	 XRC(4,133,0),     XLIT_MASK, PPCQPX, { QRT, LIT	  } },

   {"qvfrsp",    XRC(4, 12,0),     XRA_MASK, PPCQPX, { QRT,      QRB      } },
   {"qvfctid",   XRC(4,814,0),     XRA_MASK, PPCQPX, { QRT,      QRB      } },
   {"qvfctidu",  XRC(4,942,0),     XRA_MASK, PPCQPX, { QRT,      QRB      } },
   {"qvfctiduz", XRC(4,943,0),     XRA_MASK, PPCQPX, { QRT,      QRB      } },
   {"qvfctidz",  XRC(4,815,0),     XRA_MASK, PPCQPX, { QRT,      QRB      } },
   {"qvfctiw",   XRC(4, 14,0),     XRA_MASK, PPCQPX, { QRT,      QRB      } },
   {"qvfctiwu",  XRC(4,142,0),     XRA_MASK, PPCQPX, { QRT,      QRB      } },
   {"qvfctiwz",  XRC(4, 15,0),     XRA_MASK, PPCQPX, { QRT,      QRB      } },
   {"qvfctiwuz", XRC(4,143,0),     XRA_MASK, PPCQPX, { QRT,      QRB      } },
   {"qvfcfid",   XRC(4,846,0),     XRA_MASK, PPCQPX, { QRT,      QRB      } },
   {"qvfcfidu",  XRC(4,974,0),     XRA_MASK, PPCQPX, { QRT,      QRB      } },
   {"qvfrin",    XRC(4,392,0),     XRA_MASK, PPCQPX, { QRT,      QRB      } },
   {"qvfriz",    XRC(4,424,0),     XRA_MASK, PPCQPX, { QRT,      QRB      } },
   {"qvfrip",    XRC(4,456,0),     XRA_MASK, PPCQPX, { QRT,      QRB      } },
   {"qvfrim",    XRC(4,488,0),     XRA_MASK, PPCQPX, { QRT,      QRB      } },
   
   {"qvfneg",    XRC(4, 40,0),     XRA_MASK, PPCQPX, { QRT,      QRB      } },
   {"qvfmr",     XRC(4, 72,0),     XRA_MASK, PPCQPX, { QRT,      QRB      } },
   {"qvfabs",    XRC(4,264,0),     XRA_MASK, PPCQPX, { QRT,      QRB      } },
   {"qvfnabs",   XRC(4,136,0),     XRA_MASK, PPCQPX, { QRT,      QRB      } },
   
   {"qvfclr",    XRC(4,4,0),       XL_MASK,  PPCQPX, { QRT, QAT, QBA      } },
   {"qvfand",    XRC(4,68,0),      X_MASK,   PPCQPX, { QRT, QRA, QRB      } },
// skip 2 redundent forms
   {"qvfandc",   XRC(4,260,0),     X_MASK,   PPCQPX, { QRT, QRA, QRB      } },
   {"qvfctfb",   XRC(4,324,0),     XL_MASK,  PPCQPX, { QRT, QRA, QBA      } },
   {"qvfxor",    XRC(4,388,0),     X_MASK,   PPCQPX, { QRT, QRA, QRB      } },
   {"qvfor",     XRC(4,452,0),     X_MASK,   PPCQPX, { QRT, QRA, QRB      } },
   {"qvfnor",    XRC(4,516,0),     X_MASK,   PPCQPX, { QRT, QRA, QRB      } },
   {"qvfequ",    XRC(4,580,0),     X_MASK,   PPCQPX, { QRT, QRA, QRB      } },
   {"qvfnot",    XRC(4,644,0),     XL_MASK,  PPCQPX, { QRT, QRA, QBA      } },
// skip 2 redundent forms
   {"qvforc",    XRC(4,836,0),     X_MASK,   PPCQPX, { QRT, QRA, QRB      } },
   {"qvfnand",   XRC(4,900,0),     X_MASK,   PPCQPX, { QRT, QRA, QRB      } },
   {"qvfset",    XRC(4,964,0),     X_MASK,   PPCQPX, { QRT, QAT, QBA      } },
   {"qvflogical", XRC(4,4,0),    QTTTT_MASK, PPCQPX, { QRT, QRA, QRB, QTTTT } },
   
#endif

{ "fxcpnpma", A(4,24,0),  A_MASK,        PPCBGL, { FRT, FRA, FRC, FRB }},
{ "fxcsnpma", A(4,25,0),  A_MASK,        PPCBGL, { FRT, FRA, FRC, FRB }},
{ "fxcpnsma", A(4,26,0),  A_MASK,        PPCBGL, { FRT, FRA, FRC, FRB }},
{ "fxcsnsma", A(4,27,0),  A_MASK,        PPCBGL, { FRT, FRA, FRC, FRB }},
{ "fxcxnpma", A(4,29,0),  A_MASK,        PPCBGL, { FRT, FRA, FRC, FRB }},
{ "fxcxnsma", A(4,30,0),  A_MASK,        PPCBGL, { FRT, FRA, FRC, FRB }},
{ "fxcxma",   A(4,28,0),  A_MASK,        PPCBGL, { FRT, FRA, FRC, FRB }},
{ "fxcxnms",  A(4,31,0),  A_MASK,        PPCBGL, { FRT, FRA, FRC, FRB }},
...
{ "rfci",    XL(19,51),	0xffffffff,	PPC403 | PPC440 | BOOKE, { 0 } },

{ "rfsvc",   XL(19,82),	0xffffffff,	POWER,		{ 0 } },
{"rfgi",	XL(19,102),	0xffffffff,  PPCA2,	{0}},
...
#if QPX
   {"qvlfsx",      XRC(31, 519,0),   X_MASK, COM, { QRT, RA, RB } },
   {"qvlfsxa",      XRC(31, 519,1),      X_MASK, COM, { QRT, RA, RB } },
   {"qvlfsux",     XRC(31, 551,0),      X_MASK, COM, { QRT, RA, RB } },
   {"qvlfsuxa",     XRC(31, 551,1),      X_MASK, COM, { QRT, RA, RB } },
   {"qvlfdx",      XRC(31, 583,0),      X_MASK, COM, { QRT, RA, RB } },
   {"qvlfdxa",      XRC(31, 583,1),      X_MASK, COM, { QRT, RA, RB } },
   {"qvlfdux",     XRC(31, 615,0),      X_MASK, COM, { QRT, RA, RB } },
   {"qvlfduxa",     XRC(31, 615,1),      X_MASK, COM, { QRT, RA, RB } },
   {"qvlfcsx",     XRC(31,   7,0),      X_MASK, COM, { QRT, RA, RB } },
   {"qvlfcsxa",     XRC(31,   7,1),      X_MASK, COM, { QRT, RA, RB } },
   {"qvlfcsux",    XRC(31,  39,0),      X_MASK, COM, { QRT, RA, RB } },
   {"qvlfcsuxa",    XRC(31,  39,1),      X_MASK, COM, { QRT, RA, RB } },
   {"qvlfcdx",     XRC(31,  71,0),      X_MASK, COM, { QRT, RA, RB } },
   {"qvlfcdxa",     XRC(31,  71,1),      X_MASK, COM, { QRT, RA, RB } },
   {"qvlfcdux",    XRC(31, 103,0),      X_MASK, COM, { QRT, RA, RB } },
   {"qvlfcduxa",    XRC(31, 103,1),      X_MASK, COM, { QRT, RA, RB } },
   {"qvlfiwax",     XRC(31, 871,0),      X_MASK, COM, { QRT, RA, RB } },
   {"qvlfiwaxa",    XRC(31, 871,1),      X_MASK, COM, { QRT, RA, RB } },
   {"qvlfiwzx",     XRC(31, 839,0),      X_MASK, COM, { QRT, RA, RB } },
   {"qvlfiwzxa",    XRC(31, 839,1),      X_MASK, COM, { QRT, RA, RB } },

   {"qvlpcldx",    X(31, 582),      XO_MASK, COM, { QRT, RA, RB } },
   {"qvlpclsx",    X(31, 518),      XO_MASK, COM, { QRT, RA, RB } },
   {"qvlpcrdx",    X(31,  70),      XO_MASK, COM, { QRT, RA, RB } },
   {"qvlpcrsx",    X(31,   6),      XO_MASK, COM, { QRT, RA, RB } },

   {"qvstfsx" ,    XRC(31, 647,0),      X_MASK, COM, { QRS, RA, RB } },
   {"qvstfsxa" ,    XRC(31, 647,1),      X_MASK, COM, { QRS, RA, RB } },
   {"qvstfsux" ,   XRC(31, 679,0),      X_MASK, COM, { QRS, RA, RB } },
   {"qvstfsuxa" ,   XRC(31, 679,1),      X_MASK, COM, { QRS, RA, RB } },
   {"qvstfsxi" ,   XRC(31, 645,0),      X_MASK, COM, { QRS, RA, RB } },
   {"qvstfsxia" ,  XRC(31, 645,1),      X_MASK, COM, { QRS, RA, RB } },
   {"qvstfsuxi" ,  XRC(31, 677,0),      X_MASK, COM, { QRS, RA, RB } },
   {"qvstfsuxia" , XRC(31, 677,1),      X_MASK, COM, { QRS, RA, RB } },
   {"qvstfdx" ,    XRC(31, 711,0),      X_MASK, COM, { QRS, RA, RB } },
   {"qvstfdxa" ,    XRC(31, 711,1),      X_MASK, COM, { QRS, RA, RB } },
   {"qvstfdux" ,   XRC(31, 743,0),      X_MASK, COM, { QRS, RA, RB } },
   {"qvstfduxa" ,   XRC(31, 743,1),      X_MASK, COM, { QRS, RA, RB } },
   {"qvstfdxi" ,   XRC(31, 709,0),      X_MASK, COM, { QRS, RA, RB } },
   {"qvstfdxia" ,  XRC(31, 709,1),      X_MASK, COM, { QRS, RA, RB } },
   {"qvstfduxi" ,  XRC(31, 741,0),      X_MASK, COM, { QRS, RA, RB } },
   {"qvstfduxia" , XRC(31, 741,1),      X_MASK, COM, { QRS, RA, RB } },
   {"qvstfcsx" ,   XRC(31, 135,0),      X_MASK, COM, { QRS, RA, RB } },
   {"qvstfcsxa" ,   XRC(31, 135,1),      X_MASK, COM, { QRS, RA, RB } },
   {"qvstfcdx" ,   XRC(31, 199,0),      X_MASK, COM, { QRS, RA, RB } },
   {"qvstfcdxa" ,   XRC(31, 199,1),      X_MASK, COM, { QRS, RA, RB } },
   {"qvstfcsxi" ,  XRC(31, 133,0),      X_MASK, COM, { QRS, RA, RB } },
   {"qvstfcsxia" , XRC(31, 133,1),      X_MASK, COM, { QRS, RA, RB } },
   {"qvstfcdxi" ,  XRC(31, 197,0),      X_MASK, COM, { QRS, RA, RB } },
   {"qvstfcdxia" , XRC(31, 197,1),      X_MASK, COM, { QRS, RA, RB } },
   {"qvstfcsux" ,  XRC(31, 167,0),      X_MASK, COM, { QRS, RA, RB } },
   {"qvstfcsuxa" , XRC(31, 167,1),      X_MASK, COM, { QRS, RA, RB } },
   {"qvstfcdux" ,  XRC(31, 231,0),      X_MASK, COM, { QRS, RA, RB } },
   {"qvstfcduxa" ,  XRC(31, 231,1),      X_MASK, COM, { QRS, RA, RB } },
   {"qvstfcsuxi" , XRC(31, 165,0),      X_MASK, COM, { QRS, RA, RB } },
   {"qvstfcsuxia" ,XRC(31, 165,1),      X_MASK, COM, { QRS, RA, RB } },
   {"qvstfcduxi" , XRC(31, 229,0),      X_MASK, COM, { QRS, RA, RB } },
   {"qvstfcduxia" ,XRC(31, 229,1),      X_MASK, COM, { QRS, RA, RB } },
   {"qvstfiwx"  ,  XRC(31, 967,0),      X_MASK, COM, { QRS, RA, RB } },
   {"qvstfiwxa"  , XRC(31, 967,1),      X_MASK, COM, { QRS, RA, RB } },
...
{ "tlbilx",  X(31,18),		X_MASK, POWERA2,	{ RT, RA, RB } },
...
{ "icbt",    X(31,22),	X_MASK,		PPC440,	        { RA, RB } },
...
{ "ldepx",   X(31,29),	   X_MASK,	POWERA2,	{ RT, RA, RB } },
...
{ "lwepx",   X(31,31),  X_MASK,		POWERA2,	{ RT, RA, RB } },
...
{ "eratilx", X(31,51),  X_MASK,		POWERA2,	{ RT, RA, RB } },
...
{ "dcbstep", X(31,63),  XRT_MASK,	POWERA2,	{ RA, RB } },
...
{ "wait",    X(31,62),	0xffffffff,	POWERA2,	{ 0 } },
...
{ "lbepx",   X(31,95),  X_MASK,		POWERA2,	{ RT, RA, RB } },
...
{"popcntb",     X(31,122),      XRB_MASK,    POWER5|PPCA2, { RA, RS } },
{"popcntw",	X(31,378),	XRB_MASK,    PPCA2,	{RA, RS}},
{"popcntd",	X(31,506),	XRB_MASK,    PPCA2,	{RA, RS}},
...
{ "dcbfep",  X(31,127), XRT_MASK,	POWERA2,	{ RA, RB } },

{ "wrtee",   X(31,131),	XRARB_MASK,	PPC403 | BOOKE | PPC440, { RS } },
...
{ "lfssx",    X(31,142),  X_MASK,       PPCBGL, 	{ FRT, RA, RB } },
...
{ "eratsx",  XRC(31,147,0), X_MASK,	POWERA2,	{ RT, RA, RB } },
{ "eratsx.", XRC(31,147,1), X_MASK,	POWERA2,	{ RT, RA, RB } },
...
{ "prtyw",   X(31,154), XRB_MASK,	POWERA2,	{ RA, RS } },
{ "stdepx",  X(31,157), X_MASK,		POWERA2,	{ RS, RA, RB } },		
{ "stwcxe.", XRC(31,158,1), X_MASK,	BOOKE64,	{ RS, RA0, RB } },

{ "stwxe",   X(31,159), X_MASK,		BOOKE64,	{ RS, RA0, RB } },
{ "stwepx",  X(31,159), X_MASK,		POWERA2,	{ RS, RA, RB } },
...
{ "wrteei",  X(31,163),	XE_MASK,	PPC403 | BOOKE | PPC440, { E } },

{ "dcbtls",  X(31,166),	X_MASK,		PPCCHLK,	{ CT, RA, RB }},
{ "dcbtlse", X(31,174),	X_MASK,		PPCCHLK64,	{ CT, RA, RB }},

{ "lfssux",  X(31,174), X_MASK,		PPCBGL, 	{ FRT, RAS, RB } },

{ "mtmsrd",  X(31,178),	XRLARB_MASK,	PPC64,		{ RS, MTMSRD_L } },

{ "eratre",  X(31,179), X_MASK,		POWERA2,	{ RT, RA, WS } },
...
{ "prtyd",   X(31,186), XRB_MASK,	POWERA2,	{ RA, RS } },
...
{ "lfsdx",   X(31,206), X_MASK,		PPCBGL, 	{ FRT, RA, RB } },
{ "msgsnd",  X(31,206), X_MASK,		POWERA2,	{ RB } },
...
{ "stbepx",  X(31,223), X_MASK,		POWERA2,	{ RS, RA, RB } },
...
{ "lfsdux",  X(31,238), X_MASK,		PPCBGL, 	{ FRT, RAS, RB } },
{ "msgclr",  X(31,238), X_MASK,		POWERA2,	{ RB } },
...
{ "bperm",   X(31,252), X_MASK,		POWERA2,	{ CT, RA, RB } },
{ "dcbtste", X(31,253),	X_MASK,		BOOKE64,	{ CT, RA, RB } },

{ "stbuxe",  X(31,255),	X_MASK,		BOOKE64,	{ RS, RAS, RB } },
{ "dcbtstep", X(31,255), X_MASK,	POWERA2,	{ TH, RA, RB } },

{ "mfdcrx",  X(31,259),	X_MASK,		BOOKE | PPC450,	{ RS, RA } },
...
{"ehpriv",	X(31,270),	0xffffffff,  PPCA2,	{0}},

{ "lfxsx",   X(31,270), X_MASK,		PPCBGL, 	{ FRT, RA, RB } },
...
{ "lhepx",   X(31,287), X_MASK,		POWERA2,	{ RT, RA, RB } },

{ "mfdcrux", X(31,291),	X_MASK,		PPC450,		{ RS, RA } },

{ "lfxsux",  X(31,302), X_MASK,		PPCBGL, 	{ FRT, RAS, RB } },
...
{ "dcbtep",  X(31,319), X_MASK,		POWERA2,	{ TH, RA, RB } },
...
{ "mfdcr",    X(31,323),	X_MASK,	PPC403 | PPC440 | PPC450 | BOOKE, { RT, SPR } },
...
{ "lfxdx",    X(31,334),  X_MASK,        PPCBGL, { FRT, RA, RB } },
...
{ "mfpid",      XSPR(31,339,48),   XSPR_MASK, PPC440 | BOOKE,    { RT } },
{ "mfpid",      XSPR(31,339,945),  XSPR_MASK, PPC403,	{ RT } },
{ "mfcsrr0",    XSPR(31,339,58),   XSPR_MASK, PPC440 | BOOKE,    { RT } },
{ "mfcsrr1",    XSPR(31,339,59),   XSPR_MASK, PPC440 | BOOKE,    { RT } },
{ "mfdear",     XSPR(31,339,61),   XSPR_MASK, PPC440 | BOOKE,    { RT } },
{ "mfdear",     XSPR(31,339,981),  XSPR_MASK, PPC403,	{ RT } },
{ "mfesr",      XSPR(31,339,62),   XSPR_MASK, PPC440 | BOOKE,    { RT } },
{ "mfesr",      XSPR(31,339,980),  XSPR_MASK, PPC403,	{ RT } },
{ "mfivpr",     XSPR(31,339,63),   XSPR_MASK, PPC440 | BOOKE,    { RT } },
...
{ "mfusprg0",   XSPR(31,339,256),  XSPR_MASK, PPC440 | BOOKE,    { RT } },
...
{ "mfsprg4",    XSPR(31,339,260),  XSPR_MASK, PPC405 | PPC440 | BOOKE,	{ RT } },
{ "mfsprg5",    XSPR(31,339,261),  XSPR_MASK, PPC405 | PPC440 | BOOKE,	{ RT } },
{ "mfsprg6",    XSPR(31,339,262),  XSPR_MASK, PPC405 | PPC440 | BOOKE,	{ RT } },
{ "mfsprg7",    XSPR(31,339,263),  XSPR_MASK, PPC405 | PPC440 | BOOKE,	{ RT } },
{ "mfasr",      XSPR(31,339,280),  XSPR_MASK, PPC64,	{ RT } },
{ "mfear",      XSPR(31,339,282),  XSPR_MASK, PPC,	{ RT } },
{ "mfpir",      XSPR(31,339,286),  XSPR_MASK, PPC440 | BOOKE,    { RT } },
{ "mfpvr",      XSPR(31,339,287),  XSPR_MASK, PPC,	{ RT } },
{ "mfdbsr",     XSPR(31,339,304),  XSPR_MASK, PPC440 | BOOKE,    { RT } },
{ "mfdbsr",     XSPR(31,339,1008), XSPR_MASK, PPC403,	{ RT } },
{ "mfdbcr0",    XSPR(31,339,308),  XSPR_MASK, PPC440 | BOOKE,    { RT } },
{ "mfdbcr0",    XSPR(31,339,1010), XSPR_MASK, PPC405,	{ RT } },
{ "mfdbcr1",    XSPR(31,339,309),  XSPR_MASK, PPC440 | BOOKE,    { RT } },
{ "mfdbcr1",    XSPR(31,339,957),  XSPR_MASK, PPC405,	{ RT } },
{ "mfdbcr2",    XSPR(31,339,310),  XSPR_MASK, PPC440 | BOOKE,    { RT } },
{ "mfiac1",     XSPR(31,339,312),  XSPR_MASK, PPC440 | BOOKE,    { RT } },
{ "mfiac1",     XSPR(31,339,1012), XSPR_MASK, PPC403,	{ RT } },
{ "mfiac2",     XSPR(31,339,313),  XSPR_MASK, PPC440 | BOOKE,    { RT } },
{ "mfiac2",     XSPR(31,339,1013), XSPR_MASK, PPC403,	{ RT } },
{ "mfiac3",     XSPR(31,339,314),  XSPR_MASK, PPC440 | BOOKE,    { RT } },
{ "mfiac3",     XSPR(31,339,948),  XSPR_MASK, PPC405,	{ RT } },
{ "mfiac4",     XSPR(31,339,315),  XSPR_MASK, PPC440 | BOOKE,    { RT } },
{ "mfiac4",     XSPR(31,339,949),  XSPR_MASK, PPC405,	{ RT } },
{ "mfdac1",     XSPR(31,339,316),  XSPR_MASK, PPC440 | BOOKE,    { RT } },
{ "mfdac1",     XSPR(31,339,1014), XSPR_MASK, PPC403,	{ RT } },
{ "mfdac2",     XSPR(31,339,317),  XSPR_MASK, PPC440 | BOOKE,    { RT } },
{ "mfdac2",     XSPR(31,339,1015), XSPR_MASK, PPC403,	{ RT } },
{ "mfdvc1",     XSPR(31,339,318),  XSPR_MASK, PPC440 | BOOKE,    { RT } },
{ "mfdvc1",     XSPR(31,339,950),  XSPR_MASK, PPC405,	{ RT } },
{ "mfdvc2",     XSPR(31,339,319),  XSPR_MASK, PPC440 | BOOKE,    { RT } },
{ "mfdvc2",     XSPR(31,339,951),  XSPR_MASK, PPC405,	{ RT } },
{ "mftsr",      XSPR(31,339,336),  XSPR_MASK, PPC440 | BOOKE,    { RT } },
{ "mftsr",      XSPR(31,339,984),  XSPR_MASK, PPC403,	{ RT } },
{ "mftcr",      XSPR(31,339,340),  XSPR_MASK, PPC440 | BOOKE,    { RT } },
{ "mftcr",      XSPR(31,339,986),  XSPR_MASK, PPC403,	{ RT } },
{ "mfivor0",    XSPR(31,339,400),  XSPR_MASK, PPC440 | BOOKE,    { RT } },
{ "mfivor1",    XSPR(31,339,401),  XSPR_MASK, PPC440 | BOOKE,    { RT } },
{ "mfivor2",    XSPR(31,339,402),  XSPR_MASK, PPC440 | BOOKE,    { RT } },
{ "mfivor3",    XSPR(31,339,403),  XSPR_MASK, PPC440 | BOOKE,    { RT } },
{ "mfivor4",    XSPR(31,339,404),  XSPR_MASK, PPC440 | BOOKE,    { RT } },
{ "mfivor5",    XSPR(31,339,405),  XSPR_MASK, PPC440 | BOOKE,    { RT } },
{ "mfivor6",    XSPR(31,339,406),  XSPR_MASK, PPC440 | BOOKE,    { RT } },
{ "mfivor7",    XSPR(31,339,407),  XSPR_MASK, PPC440 | BOOKE,    { RT } },
{ "mfivor8",    XSPR(31,339,408),  XSPR_MASK, PPC440 | BOOKE,    { RT } },
{ "mfivor9",    XSPR(31,339,409),  XSPR_MASK, PPC440 | BOOKE,    { RT } },
{ "mfivor10",   XSPR(31,339,410),  XSPR_MASK, PPC440 | BOOKE,    { RT } },
{ "mfivor11",   XSPR(31,339,411),  XSPR_MASK, PPC440 | BOOKE,    { RT } },
{ "mfivor12",   XSPR(31,339,412),  XSPR_MASK, PPC440 | BOOKE,    { RT } },
{ "mfivor13",   XSPR(31,339,413),  XSPR_MASK, PPC440 | BOOKE,    { RT } },
{ "mfivor14",   XSPR(31,339,414),  XSPR_MASK, PPC440 | BOOKE,    { RT } },
{ "mfivor15",   XSPR(31,339,415),  XSPR_MASK, PPC440 | BOOKE,    { RT } },
...
{ "mfmmucr",  	XSPR(31,339,946),  XSPR_MASK, PPC440,	{ RT } },
{ "mfccr0",  	XSPR(31,339,947),  XSPR_MASK, PPC405 | PPC440,	{ RT } },
...
{ "mftb",       XSPR(31,339,268),  XSPR_MASK, BOOKE,    { RT, TBR } },
{ "mftbu",      XSPR(31,339,269),  XSPR_MASK, BOOKE,    { RT, TBR } },
...
{ "dci",     X(31,454), XRARB_MASK,	POWERA2,	{ CT } },
...
{ "lfxdux",   X(31,366),  X_MASK,        PPCBGL, { FRT, RAS, RB } },
...
{ "mtdcrx",  X(31,387),	X_MASK,		BOOKE | PPC450, { RA, RS } },
...
{ "lfpsx",   X(31,398),  X_MASK,    PPCBGL, 	{ FRT, RA, RB } },

{ "sthx",    X(31,407),	X_MASK,		COM,		{ RS, RA0, RB } },

{ "mtdcrux", X(31,419),	X_MASK,		PPC450,		{ RA, RS } },

{ "lfqx",    X(31,791),	X_MASK,		POWER2,		{ FRT, RA, RB } },

{ "erativax",X(31,819), X_MASK,		POWERA2,	{ RS, RA, RB } },
...
{ "sthepx",  X(31,415), X_MASK,		POWERA2,	{ RS, RA, RB } },

{ "lfpsux",   X(31,430),  X_MASK,        PPCBGL, 	{ FRT, RA, RB } },
...
{ "mtdcr",    X(31,451),	X_MASK,	PPC403 | PPC440 | PPC450 | BOOKE, { SPR, RS } },
...
{ "lfpdx",    X(31,462),  X_MASK,        PPCBGL, { FRT, RA, RB } },
...
{ "mtpid",     XSPR(31,467,48),   XSPR_MASK, PPC440 | BOOKE,     { RS } },
{ "mtpid",     XSPR(31,467,945),  XSPR_MASK, PPC403,	{ RS } },
{ "mtdecar",   XSPR(31,467,54),   XSPR_MASK, PPC440 | BOOKE,     { RS } },
{ "mtcsrr0",   XSPR(31,467,58),   XSPR_MASK, PPC440 | BOOKE,     { RS } },
{ "mtcsrr1",   XSPR(31,467,59),   XSPR_MASK, PPC440 | BOOKE,     { RS } },
{ "mtdear",    XSPR(31,467,61),   XSPR_MASK, PPC440 | BOOKE,     { RS } },
{ "mtdear",    XSPR(31,467,981),  XSPR_MASK, PPC403,	{ RS } },
{ "mtesr",     XSPR(31,467,62),   XSPR_MASK, PPC440 | BOOKE,     { RS } },
{ "mtesr",     XSPR(31,467,980),  XSPR_MASK, PPC403,	{ RS } },
{ "mtivpr",    XSPR(31,467,63),   XSPR_MASK, PPC440 | BOOKE,     { RS } },
...
{ "mtusprg0",  XSPR(31,467,256),  XSPR_MASK, PPC440 | BOOKE,     { RS } },
{ "mtsprg",    XSPR(31,467,256),  XSPRG_MASK,PPC,	{ SPRG, RS } },
{ "mtsprg0",   XSPR(31,467,272),  XSPR_MASK, PPC,	{ RS } },
{ "mtsprg1",   XSPR(31,467,273),  XSPR_MASK, PPC,	{ RS } },
{ "mtsprg2",   XSPR(31,467,274),  XSPR_MASK, PPC,	{ RS } },
{ "mtsprg3",   XSPR(31,467,275),  XSPR_MASK, PPC,	{ RS } },
{ "mtsprg4",   XSPR(31,467,276),  XSPR_MASK, PPC405 | PPC440 | BOOKE, { RS } },
{ "mtsprg5",   XSPR(31,467,277),  XSPR_MASK, PPC405 | PPC440 | BOOKE, { RS } },
{ "mtsprg6",   XSPR(31,467,278),  XSPR_MASK, PPC405 | PPC440 | BOOKE, { RS } },
{ "mtsprg7",   XSPR(31,467,279),  XSPR_MASK, PPC405 | PPC440 | BOOKE, { RS } },
{ "mtasr",     XSPR(31,467,280),  XSPR_MASK, PPC64,	{ RS } },
{ "mtear",     XSPR(31,467,282),  XSPR_MASK, PPC,	{ RS } },
{ "mttbl",     XSPR(31,467,284),  XSPR_MASK, PPC,	{ RS } },
{ "mttbu",     XSPR(31,467,285),  XSPR_MASK, PPC,	{ RS } },
{ "mtdbsr",    XSPR(31,467,304),  XSPR_MASK, PPC440 | BOOKE,     { RS } },
{ "mtdbsr",    XSPR(31,467,1008), XSPR_MASK, PPC403,	{ RS } },
{ "mtdbcr0",   XSPR(31,467,308),  XSPR_MASK, PPC440 | BOOKE,     { RS } },
{ "mtdbcr0",   XSPR(31,467,1010), XSPR_MASK, PPC405,	{ RS } },
{ "mtdbcr1",   XSPR(31,467,309),  XSPR_MASK, PPC440 | BOOKE,     { RS } },
{ "mtdbcr1",   XSPR(31,467,957),  XSPR_MASK, PPC405,	{ RS } },
{ "mtdbcr2",   XSPR(31,467,310),  XSPR_MASK, PPC440 | BOOKE,     { RS } },
{ "mtiac1",    XSPR(31,467,312),  XSPR_MASK, PPC440 | BOOKE,     { RS } },
{ "mtiac1",    XSPR(31,467,1012), XSPR_MASK, PPC403,	{ RS } },
{ "mtiac2",    XSPR(31,467,313),  XSPR_MASK, PPC440 | BOOKE,     { RS } },
{ "mtiac2",    XSPR(31,467,1013), XSPR_MASK, PPC403,	{ RS } },
{ "mtiac3",    XSPR(31,467,314),  XSPR_MASK, PPC440 | BOOKE,     { RS } },
{ "mtiac3",    XSPR(31,467,948),  XSPR_MASK, PPC405,	{ RS } },
{ "mtiac4",    XSPR(31,467,315),  XSPR_MASK, PPC440 | BOOKE,     { RS } },
{ "mtiac4",    XSPR(31,467,949),  XSPR_MASK, PPC405,	{ RS } },
{ "mtdac1",    XSPR(31,467,316),  XSPR_MASK, PPC440 | BOOKE,     { RS } },
{ "mtdac1",    XSPR(31,467,1014), XSPR_MASK, PPC403,	{ RS } },
{ "mtdac2",    XSPR(31,467,317),  XSPR_MASK, PPC440 | BOOKE,     { RS } },
{ "mtdac2",    XSPR(31,467,1015), XSPR_MASK, PPC403,	{ RS } },
{ "mtdvc1",    XSPR(31,467,318),  XSPR_MASK, PPC440 | BOOKE,     { RS } },
{ "mtdvc1",    XSPR(31,467,950),  XSPR_MASK, PPC405,	{ RS } },
{ "mtdvc2",    XSPR(31,467,319),  XSPR_MASK, PPC440 | BOOKE,     { RS } },
{ "mtdvc2",    XSPR(31,467,951),  XSPR_MASK, PPC405,	{ RS } },
{ "mttsr",     XSPR(31,467,336),  XSPR_MASK, PPC440 | BOOKE,     { RS } },
{ "mttsr",     XSPR(31,467,984),  XSPR_MASK, PPC403,	{ RS } },
{ "mttcr",     XSPR(31,467,340),  XSPR_MASK, PPC440 | BOOKE,     { RS } },
{ "mttcr",     XSPR(31,467,986),  XSPR_MASK, PPC403,	{ RS } },
{ "mtivor0",   XSPR(31,467,400),  XSPR_MASK, PPC440 | BOOKE,     { RS } },
{ "mtivor1",   XSPR(31,467,401),  XSPR_MASK, PPC440 | BOOKE,     { RS } },
{ "mtivor2",   XSPR(31,467,402),  XSPR_MASK, PPC440 | BOOKE,     { RS } },
{ "mtivor3",   XSPR(31,467,403),  XSPR_MASK, PPC440 | BOOKE,     { RS } },
{ "mtivor4",   XSPR(31,467,404),  XSPR_MASK, PPC440 | BOOKE,     { RS } },
{ "mtivor5",   XSPR(31,467,405),  XSPR_MASK, PPC440 | BOOKE,     { RS } },
{ "mtivor6",   XSPR(31,467,406),  XSPR_MASK, PPC440 | BOOKE,     { RS } },
{ "mtivor7",   XSPR(31,467,407),  XSPR_MASK, PPC440 | BOOKE,     { RS } },
{ "mtivor8",   XSPR(31,467,408),  XSPR_MASK, PPC440 | BOOKE,     { RS } },
{ "mtivor9",   XSPR(31,467,409),  XSPR_MASK, PPC440 | BOOKE,     { RS } },
{ "mtivor10",  XSPR(31,467,410),  XSPR_MASK, PPC440 | BOOKE,     { RS } },
{ "mtivor11",  XSPR(31,467,411),  XSPR_MASK, PPC440 | BOOKE,     { RS } },
{ "mtivor12",  XSPR(31,467,412),  XSPR_MASK, PPC440 | BOOKE,     { RS } },
{ "mtivor13",  XSPR(31,467,413),  XSPR_MASK, PPC440 | BOOKE,     { RS } },
{ "mtivor14",  XSPR(31,467,414),  XSPR_MASK, PPC440 | BOOKE,     { RS } },
{ "mtivor15",  XSPR(31,467,415),  XSPR_MASK, PPC440 | BOOKE,     { RS } },
...
{ "mtccr0",    XSPR(31,467,947),  XSPR_MASK, PPC440 | PPC405,	{ RS } },
...
{ "lfpdux",   X(31,494),  X_MASK,        PPCBGL, { FRT, RAS, RB } },

{ "slbia",   X(31,498),	0xffffffff,	PPC64,		{ 0 } },

{ "cli",     X(31,502), XRB_MASK,	POWER,		{ RT, RA } },

{ "cmpb",    X(31,508), XCMP_MASK,      POWERA2,        { RA, RS, RB } },
...
{ "stfpiwx",  X(31,526),  X_MASK,        PPCBGL, { FRT, RA, RB } },

{ "mcrxr64", X(31,544),	XRARB_MASK|(3<<21), BOOKE64,	{ BF } },

{ "clcs",    X(31,531), XRB_MASK,	M601,		{ RT, RA } },

{ "ldbrx",   X(31,532), X_MASK,		POWERA2,	{ RT, RA0, RB } },
...
{ "msync",   X(31,598), 0xffffffff,	PPC440 | BOOKE,		{ 0 } },
...
{ "stfssx",   X(31,654),  X_MASK,        PPCBGL, { FRT, RA, RB } },

{ "mfsrin",  X(31,659), XRA_MASK,	PPC32,		{ RT, RB } },

{ "stdbrx",  X(31,660), X_MASK,		POWERA2,	{ RS, RA0, RB } },
...
{ "stfsdx",  X(31,718),  X_MASK,        PPCBGL, { FRT, RA, RB } },
...
{ "stfsdux",  X(31,750),  X_MASK,        PPCBGL, { FRT, RAS, RB } },

{ "dcba",    X(31,758),	XRT_MASK,	PPC405 | PPC440 | BOOKE,	{ RA, RB } },
...
{ "stfxsx",   X(31,782),  X_MASK,        PPCBGL, { FRT, RA, RB } },
...
{ "stfxsux",  X(31,814),  X_MASK,        PPCBGL, { FRT, RAS, RB } },
...
{ "stfxdx",   X(31,846),  X_MASK,        PPCBGL, { FRT, RA, RB } },

{ "tlbsrx.", XRC(31,850,1), XRT_MASK,	POWERA2,	{ RA, RB } },

{ "slbmfev", X(31,851), XRA_MASK,	PPC64,		{ RT, RB } },

{ "mbar",    X(31,854),	X_MASK,		PPC440 | BOOKE,		{ MO } },
{ "eieio",   X(31,854),	0xffffffff,	PPC,		{ 0 } },

{ "stfxdux",  X(31,878),  X_MASK,        PPCBGL, { FRT, RAS, RB } },
{ "eratsrx.", X(31,883),  X_MASK,	POWERA2,	{ RS, RA, RB } },

{ "stfpsx",   X(31,910),  X_MASK,        PPCBGL, { FRT, RA, RB } },
...
{ "stfpsux",  X(31,942),  X_MASK,        PPCBGL, { FRT, RAS, RB } },

{ "tlbrehi", XTLB(31,946,0), XTLB_MASK,	PPC403,		{ RT, RA } },
{ "tlbrelo", XTLB(31,946,1), XTLB_MASK,	PPC403,		{ RT, RA } },
{ "tlbre",   X(31,946),	X_MASK,		PPC403|PPC440|BOOKE,	{ RSO, RAOPT, SHO } },
...
{ "ici",     X(31,966), XRARB_MASK,	POWERA2,	{ CT } },

{ "stfpdx",   X(31,974),  X_MASK,        PPCBGL, { FRT, RA, RB } },

{ "tlbwehi", XTLB(31,978,0), XTLB_MASK,	PPC403,		{ RT, RA } },
{ "tlbwelo", XTLB(31,978,1), XTLB_MASK,	PPC403,		{ RT, RA } },
{ "tlbwe",   X(31,978),	X_MASK,		PPC403|PPC440 | BOOKE,	{ RSO, RAOPT, SHO } },
{ "tlbld",   X(31,978),	XRTRA_MASK,	PPC,		{ RB } },

{ "eratwehi", XTLB(31,211,0), XTLB_MASK,	PPC403,		{ RT, RA } },
{ "eratwelo", XTLB(31,211,1), XTLB_MASK,	PPC403,		{ RT, RA } },
{ "eratwe",   X(31,211),	X_MASK,		PPC403|PPC440 | BOOKE,	{ RSO, RAOPT, SHO } },
{ "eratld",   X(31,211),	XRTRA_MASK,	PPC,		{ RB } },

{ "icbi",    X(31,982),	XRT_MASK,	PPC,		{ RA, RB } },

{ "stfiwx",  X(31,983),	X_MASK,		PPC,		{ FRS, RA0, RB } },

{ "icbiep",  X(31,991), XRT_MASK,	POWERA2,	{ RA, RB } },
...
{ "stfpdux", X(31,1006), X_MASK, 	PPCBGL, 	{FRT, RAS, RB } },
...
{ "dcbzep",  X(31,1023), XRT_MASK,	POWERA2,	{ RA, RB } },
...
std::string PpcDecode::decodeInst(uint32_t insn)
{
    ostringstream os;
    ...
    int dialect = PPC_OPCODE_PPC | PPC_OPCODE_64 | PPC_OPCODE_COMMON | PPC_OPCODE_ANY;
    ...
    for (opcode = powerpc_opcodes; opcode < opcode_end; opcode++)
    {
       ...
       instruction is valid.  */
        ...
        if (opcode->operands[0] != 0)
            os << setw(7) << setfill(' ') << std::left << opcode->name;
        else
            os << opcode->name;
