...
enum ReturnCode {
   ...
   ReturnCodeReserved1,           //!< Obsolete: was RequestInProgress.
   ...
   ToolConflictingCmds,           //!< Tool message contains an invalid combination of commands in the command list.
   ToolControlRequired,           //!< Tool control authority is required.
   ToolControlReleaseRequired,    //!< Tool release of control authority is required. 
   AppInvalidorMissingMapfile,    //!< Map file is missing or contains invalid values.
   ToolProcessExiting,            //!< Tool message not handled because target process is exiting.
