...
#ifndef BGWS_BLUE_GENE_SERVICE_ACTIONS_CLOSE_SERVICE_ACTION_HPP_
#define BGWS_BLUE_GENE_SERVICE_ACTIONS_CLOSE_SERVICE_ACTION_HPP_
...
class CloseServiceAction : public boost::enable_shared_from_this<CloseServiceAction>
{
public:
