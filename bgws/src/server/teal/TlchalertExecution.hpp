...
#ifndef BGWS_TEAL_TLCHALERT_EXECUTION_HPP_
#define BGWS_TEAL_TLCHALERT_EXECUTION_HPP_
...
class TlchalertExecution : public boost::enable_shared_from_this<TlchalertExecution>
{
public:

    typedef boost::shared_ptr<TlchalertExecution> Ptr;
