...
#ifndef BGWS_RESPONDER_ENVIRONMENTALS_SERVICE_CARD_TEMP_HPP_
#define BGWS_RESPONDER_ENVIRONMENTALS_SERVICE_CARD_TEMP_HPP_
...
class ServiceCardTemp : public AbstractResponder
{
public:
