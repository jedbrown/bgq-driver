...
#ifndef BGWS_RESPONDER_ENVIRONMENTALS_SERVICE_CARD_HPP_
#define BGWS_RESPONDER_ENVIRONMENTALS_SERVICE_CARD_HPP_
...
class ServiceCard : public AbstractResponder
{
public:
