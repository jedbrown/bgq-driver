...
#ifndef BGWS_QUERY_ENV_SERVICE_CARD_TEMP_OPTIONS_HPP_
#define BGWS_QUERY_ENV_SERVICE_CARD_TEMP_OPTIONS_HPP_
...
class ServiceCardTempOptions : public AbstractOptions
{
public:
    ...
    // override
    const std::string& getTableName()  { static const std::string ret("bgqServiceCardTemp"); return ret; }
...
private:
    ...
    IntegerCompareOption _onboard_temp;
};
