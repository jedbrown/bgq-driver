...
#ifndef BGWS_QUERY_ENV_NODE_OPTIONS_HPP_
#define BGWS_QUERY_ENV_NODE_OPTIONS_HPP_
...
class NodeOptions : public AbstractOptions
{
public:
    ...
    // override
    const std::string& getTableName()  { static const std::string ret("bgqNodeEnvironment"); return ret; }
