...
#include "DiagnosticsLocationsOptions.hpp"
...
DiagnosticsLocationsOptions::DiagnosticsLocationsOptions(
        ...
        _range(range)
{
    ...
    desc.add_options()
            ( "hardwareStatus", po::value<string>()->notifier( bind( &DiagnosticsLocationsOptions::_notifyHardwareStatus, this, _1 ) ) )
            ( "replace", po::value<string>()->notifier( bind( &DiagnosticsLocationsOptions::_notifyReplace, this, _1 ) ) )
...
void DiagnosticsLocationsOptions::calcWhereClause(
        WhereClause* loc_out,
...
std::string DiagnosticsLocationsOptions::calcSortClauseSql()
{
...
void DiagnosticsLocationsOptions::bindParameters(
...
void DiagnosticsLocationsOptions::_notifyHardwareStatus( const std::string& s )
{
...
void DiagnosticsLocationsOptions::_notifyReplace( const std::string& s )
{
    if ( s == "any" )  return;
