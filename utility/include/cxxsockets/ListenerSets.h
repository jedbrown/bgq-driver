...
#ifndef _LISTENERSETS_H
#define _LISTENERSETS_H
...
namespace CxxSockets {
    ...
    public:
        ...
        ListenerSet(SockAddrList& sal, int backlog = SOMAXCONN, Policy p = INSECURE);
    ...
    public:
        PollingListenerSet(Policy p = INSECURE) {}
        ...
        //! \param p
        PollingListenerSet(SockAddrList& sal, int backlog = SOMAXCONN, Policy p = INSECURE);
        ~PollingListenerSet() { }
        ...
        bool AcceptNew(SecureTCPSocketPtr& sock, bgq::utility::ServerPortConfiguration& port_config);
    private:
        bool AcceptNewCommon(SecureTCPSocketPtr& secure_sock, TCPSocketPtr& sock, bgq::utility::ServerPortConfiguration& port_config, bool secure);
    };

    //! \brief Epolling set of listeners
    class EpollingListenerSet : public EpollingSocketSet {
    public:
        EpollingListenerSet(Policy p = INSECURE) {}
        ...
        //! \param backlog The maximum number of pending connections allowed
        //! \param p
        EpollingListenerSet(SockAddrList& sal, int backlog = SOMAXCONN, Policy p = INSECURE);
