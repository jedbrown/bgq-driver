...
/**
 * \file components/devices/shmem/qpx_16way_max.h
 * \brief ???
 */
#ifndef __components_devices_shmem_qpx_16way_max_h__
#define __components_devices_shmem_qpx_16way_max_h__
    ...
    double* src12, double* src13, double* src14, double* src15, unsigned num_dbls)
{
  ...
  ASM("qvfadd 28, 28, 15" ::: "fr28"  ); //first first-half max done
  ...
  ASM("qvfadd 30, 30, 17" ::: "fr30"  );
  QPX_LOAD(src0_1,inc,f16);
  ASM("qvfadd 29, 0, 1" ::: "fr29"  ); 	//second first-half max start
  ...
  QPX_LOAD(src10_1,inc,f10);
  ASM("qvfadd 30, 30, 19" ::: "fr30"  ); //first second-half max done
  QPX_LOAD(src2_1,inc,f18);
  ...
  QPX_LOAD(src12_1,inc,f12);
  ASM("qvfadd 31, 16, 17" ::: "fr31"  ); //second second-half max start
  QPX_LOAD(src4_1,inc,f16);
    ...
    double* src12, double* src13, double* src14, double* src15, unsigned num_dbls)
{
  ...
  QPX_LOAD(src10_1,inc,f10);
  ASM("qvfadd 30, 30, 15" ::: "fr30"  ); //first second-half max done
  QPX_LOAD(src2_1,inc,f2);
  ASM("qvfadd 29, 29, 3" ::: "fr29"  );
  ...
  QPX_LOAD(src12_1,inc,f12);
  ASM("qvfadd 31, 0, 1" ::: "fr31"  ); //second second-half max start
  QPX_LOAD(src4_1,inc,f4);
  ASM("qvfadd 29, 29, 5" ::: "fr29"  );
  QPX_STORE(dst_2,inc1,f30);
...
inline unsigned _quad_double_max_16way_align32B_short(double* dst, double* src0, double *src1, double* src2, double* src3,
    double* src4, double* src5, double* src6, double* src7, double* src8, double *src9, double* src10, double* src11,
    double* src12, double* src13, double* src14, double* src15, unsigned num_dbls)
{
  register double f0  FP_REGISTER(0) = 0.0;
...
inline unsigned _quad_double_max_16way_single(double* dst, double* src0, double *src1, double* src2, double* src3,
    double* src4, double* src5, double* src6, double* src7, double* src8, double *src9, double* src10, double* src11,
    double* src12, double* src13, double* src14, double* src15, unsigned num_dbls)
{
...
inline unsigned _quad_double_max_16way_align32B(double* dst, double* src0, double *src1, double* src2, double* src3,
    double* src4, double* src5, double* src6, double* src7, double* src8, double *src9, double* src10, double* src11,
    double* src12, double* src13, double* src14, double* src15, unsigned num_dbls)
{
  ...
  if (is_64B_aligned)
  {
    dbls = _quad_double_max_16way_align64B(dst, src0, src1, src2, src3, src4, src5, src6, src7, src8, 
                                          src9, src10, src11, src12, src13, src14, src15, num_dbls);
    if (dbls == num_dbls) return dbls;
    _quad_double_max_16way_single(dst+dbls, src0+dbls, src1+dbls, src2+dbls, src3+dbls, src4+dbls, 
  ...
  /*_quad_double_max_16way_single(dst, src0, src1, src2, src3, src4, src5, src6, src7, src8, 
                                src9, src10, src11, src12, src13, src14, src15, 4);

  dbls = _quad_double_max_16way_align64B(dst+4, src0+4, src1+4, src2+4, src3+4, src4+4, src5+4, src6+4, src7+4, src8+4, 
...
inline unsigned quad_double_max_16way(double* dst, double* src0, double *src1, double* src2, double* src3,
    double* src4, double* src5, double* src6, double* src7, double* src8, double *src9, double* src10, double* src11,
    double* src12, double* src13, double* src14, double* src15, unsigned num_dbls)
{
  ...
  if (num_dbls < 20)
   ...
   dbls = _quad_double_max_16way_align32B(dst, src0, src1, src2, src3, src4, src5, src6, src7, src8,
                                          src9, src10, src11, src12, src13, src14, src15, num_dbls);

  if (num_dbls - dbls)
   return _quad_double_max_16way_single(dst+dbls, src0+dbls, src1+dbls, src2+dbls, src3+dbls, src4+dbls, 
                                  src5+dbls, src6+dbls, src7+dbls, src8+dbls, src9+dbls, src10+dbls, src11+dbls, 
                                  src12+dbls, src13+dbls, src14+dbls, src15+dbls, num_dbls - dbls);
    ...
    double* src12, double* src13, double* src14, double* src15, unsigned num_dbls)
{
  ...
  {
    dbls = quad_double_max_8way(dst, src0, src1, src2, src3, src4, src5, src6, src7, num_dbls);
    /*for (unsigned i=0; i < num_dbls; i++)
    { printf("[%d]:%f\t",i, dst[i]); printf("\n");}*/
    dbls = quad_double_max_8way(dst, dst, src8, src9, src10, src11, src12, src13, src14, num_dbls);
    /*for (unsigned i=0; i < num_dbls; i++)
    { printf("[%d]:%f\t",i, dst[i]); printf("\n");}*/
    dbls = quad_double_max_2way(dst, dst, src15, num_dbls);
    /*for (unsigned i=0; i < num_dbls; i++)
    { printf("[%d]:%f\t",i, dst[i]); printf("\n");}*/
  }
