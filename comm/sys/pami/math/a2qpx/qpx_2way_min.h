...
/**
 * \file components/devices/shmem/qpx_2way_min.h
 * \brief ???
 */
#ifndef __components_devices_shmem_qpx_2way_min_h__
#define __components_devices_shmem_qpx_2way_min_h__
...
inline unsigned _quad_double_min_2way_align64B(double* dst, double* src0, double *src1, unsigned num_dbls)
{
...
inline unsigned _quad_double_min_2way_align32B(double* dst, double* src0, double *src1, unsigned num_dbls)
{
