...
extern void _pami_qpx_fp64_sum_2way(double *dst, const double **srcs, int nsrc, int count);
extern void _pami_qpx_fp64_min_2way(double *dst, const double **srcs, int nsrc, int count); 
extern void _pami_qpx_fp64_max_2way(double *dst, const double **srcs, int nsrc, int count); 
extern void _pami_qpx_fp64_sum_3way(double *dst, const double **srcs, int nsrc, int count); 
extern void _pami_qpx_fp64_min_3way(double *dst, const double **srcs, int nsrc, int count); 
extern void _pami_qpx_fp64_max_3way(double *dst, const double **srcs, int nsrc, int count); 
extern void _pami_qpx_fp64_sum_4way(double *dst, const double **srcs, int nsrc, int count); 
extern void _pami_qpx_fp64_min_4way(double *dst, const double **srcs, int nsrc, int count); 
extern void _pami_qpx_fp64_max_4way(double *dst, const double **srcs, int nsrc, int count); 
extern void _pami_qpx_fp64_sum_8way(double *dst, const double **srcs, int nsrc, int count); 
extern void _pami_qpx_fp64_min_8way(double *dst, const double **srcs, int nsrc, int count); 
extern void _pami_qpx_fp64_max_8way(double *dst, const double **srcs, int nsrc, int count); 
extern void _pami_qpx_fp64_sum_16way(double *dst, const double **srcs, int nsrc, int count); 
extern void _pami_qpx_fp64_min_16way(double *dst, const double **srcs, int nsrc, int count);
extern void _pami_qpx_fp64_max_16way(double *dst, const double **srcs, int nsrc, int count);
...
#define OPTIMIZED_fp64_sum   \
  OPTIMATH_NSRC(PAMI_DOUBLE,PAMI_SUM, 2,_pami_qpx_fp64_sum_2way) \
  OPTIMATH_NSRC(PAMI_DOUBLE,PAMI_SUM, 3,_pami_qpx_fp64_sum_3way) \
  OPTIMATH_NSRC(PAMI_DOUBLE,PAMI_SUM, 4,_pami_qpx_fp64_sum_4way) \
  OPTIMATH_NSRC(PAMI_DOUBLE,PAMI_SUM, 8,_pami_qpx_fp64_sum_8way) \
  OPTIMATH_NSRC(PAMI_DOUBLE,PAMI_SUM,16,_pami_qpx_fp64_sum_16way) 
#define OPTIMIZED_fp64_min   \
  OPTIMATH_NSRC(PAMI_DOUBLE,PAMI_MIN, 2,_pami_qpx_fp64_min_2way) \
  OPTIMATH_NSRC(PAMI_DOUBLE,PAMI_MIN, 3,_pami_qpx_fp64_min_3way) \
  OPTIMATH_NSRC(PAMI_DOUBLE,PAMI_MIN, 4,_pami_qpx_fp64_min_4way) \
  OPTIMATH_NSRC(PAMI_DOUBLE,PAMI_MIN, 8,_pami_qpx_fp64_min_8way) \
  OPTIMATH_NSRC(PAMI_DOUBLE,PAMI_MIN,16,_pami_qpx_fp64_min_16way) 
#define OPTIMIZED_fp64_prod
#define OPTIMIZED_fp64_max    \
  OPTIMATH_NSRC(PAMI_DOUBLE,PAMI_MAX, 2,_pami_qpx_fp64_max_2way) \
  OPTIMATH_NSRC(PAMI_DOUBLE,PAMI_MAX, 3,_pami_qpx_fp64_max_3way) \
  OPTIMATH_NSRC(PAMI_DOUBLE,PAMI_MAX, 4,_pami_qpx_fp64_max_4way) \
  OPTIMATH_NSRC(PAMI_DOUBLE,PAMI_MAX, 8,_pami_qpx_fp64_max_8way) \
  OPTIMATH_NSRC(PAMI_DOUBLE,PAMI_MAX,16,_pami_qpx_fp64_max_16way) 
