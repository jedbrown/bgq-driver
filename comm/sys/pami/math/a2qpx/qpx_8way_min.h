...
/**
 * \file components/devices/shmem/qpx_8way_min.h
 * \brief ???
 */
#ifndef __components_devices_shmem_qpx_8way_min_h__
#define __components_devices_shmem_qpx_8way_min_h__
...
inline unsigned _quad_double_min_8way_align64B(double* dst, double* src0, double *src1, double* src2, double* src3,
    double* src4, double* src5, double* src6, double* src7, unsigned num_dbls)
{
...
inline unsigned _quad_double_min_8way_align32B_short(double* dst, double* src0, double *src1, double* src2, double* src3,
    double* src4, double* src5, double* src6, double* src7, unsigned num_dbls)
{
  register double f0  FP_REGISTER(0) = 0.0;
  register double f1  FP_REGISTER(1) = 0.0;
...
inline unsigned _quad_double_min_8way_single(double* dst, double* src0, double *src1, double* src2, double* src3,
    double* src4, double* src5, double* src6, double* src7, unsigned num_dbls)
{
...
inline unsigned _quad_double_min_8way_align32B(double* dst, double* src0, double *src1, double* src2, double* src3,
    double* src4, double* src5, double* src6, double* src7, unsigned num_dbls)
{
  ...
  if (is_64B_aligned)
  {
    dbls = _quad_double_min_8way_align64B(dst, src0, src1, src2, src3, src4, src5, src6, src7, num_dbls);
    if (dbls == num_dbls) return dbls;
    _quad_double_min_8way_single(dst+dbls, src0+dbls, src1+dbls, src2+dbls, src3+dbls, src4+dbls, 
                                  src5+dbls, src6+dbls, src7+dbls, num_dbls - dbls);
    return num_dbls;
  }

  /*_quad_double_min_8way_single(dst, src0, src1, src2, src3, src4, src5, src6, src7, 4);

  dbls = _quad_double_min_8way_align64B(dst+4, src0+4, src1+4, src2+4, src3+4, src4+4, src5+4, src6+4, src7+4, num_dbls - 4);
  dbls+=4;*/
   dbls = _quad_double_min_8way_align32B_short(dst, src0, src1, src2, src3, src4, src5, src6, src7, num_dbls);
...
inline unsigned quad_double_min_8way(double* dst, double* src0, double *src1, double* src2, double* src3,
    double* src4, double* src5, double* src6, double* src7, unsigned num_dbls)
{
  ...
  {
    _pami_core_double_min_8way(dst, src0, src1, src2, src3, src4, src5, src6, src7, num_dbls);
    return 0;
  }
  ...
  if (num_dbls < 20)
   ...
   dbls = _quad_double_min_8way_align32B(dst, src0, src1, src2, src3, src4, src5, src6, src7, num_dbls);
