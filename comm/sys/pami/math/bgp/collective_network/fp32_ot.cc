...
void _pami_core_fp32_pre_max_o(float *dst, const float *src, int count) {
...
void _pami_core_fp32_post_max_o(float *dst, const float *src, int count) {
  uint32_t *d=(uint32_t*)dst, *s=(uint32_t*)src;
  register int n=0;
  register unsigned d0, d1, d2, d3;
  register unsigned s0, s1, s2, s3;
...
void _pami_core_fp32_int32_pre_maxloc_o(fp32_int32_t *dst, const fp32_int32_t *src, int count) {
  register int n = 0;
...
void _pami_core_fp32_int32_post_maxloc_o(fp32_int32_t *dst, const fp32_int32_t *src, int count) {
  register int n = 0;
  uint32_int32_t *d=(uint32_int32_t*)dst, *s=(uint32_int32_t*)src;
  for (n = 0; n < count; n++)
    {
...
void _pami_core_fp32_fp32_pre_maxloc_o(fp32_fp32_t *dst, const fp32_fp32_t *src, int count) {
  register int n = 0;
...
void _pami_core_fp32_fp32_post_maxloc_o(fp32_fp32_t *dst, const fp32_fp32_t *src, int count) {
  register int n = 0;
  uint32_uint32_t *d=(uint32_uint32_t*)dst, *s=(uint32_uint32_t*)src;
  for (n = 0; n < count; n++)
    {
...
void _pami_core_fp32_pre_min_o(float *dst, const float *src, int count) {
  uint32_t *d=(uint32_t*)dst, *s=(uint32_t*)src;
  register int n=0;
  register unsigned d0, d1, d2, d3;
  register unsigned s0, s1, s2, s3;
...
void _pami_core_fp32_post_min_o(float *dst, const float *src, int count) {
  uint32_t *d=(uint32_t*)dst, *s=(uint32_t*)src;
  register int n=0;
  register unsigned d0, d1, d2, d3;
  register unsigned s0, s1, s2, s3;
...
void _pami_core_fp32_int32_pre_minloc_o(fp32_int32_t *dst, const fp32_int32_t *src, int count) {
  register int n = 0;
  uint32_int32_t *d=(uint32_int32_t*)dst, *s=(uint32_int32_t*)src;
  for (n = 0; n < count; n++)
    {
...
void _pami_core_fp32_int32_post_minloc_o(fp32_int32_t *dst, const fp32_int32_t *src, int count) {
  register int n = 0;
  uint32_int32_t *d=(uint32_int32_t*)dst, *s=(uint32_int32_t*)src;
  for (n = 0; n < count; n++)
    {
...
void _pami_core_fp32_fp32_pre_minloc_o(fp32_fp32_t *dst, const fp32_fp32_t *src, int count) {
  register int n = 0;
  uint32_uint32_t *d=(uint32_uint32_t*)dst, *s=(uint32_uint32_t*)src;
  for (n = 0; n < count; n++)
    {
...
void _pami_core_fp32_fp32_post_minloc_o(fp32_fp32_t *dst, const fp32_fp32_t *src, int count) {
  register int n = 0;
  uint32_uint32_t *d=(uint32_uint32_t*)dst, *s=(uint32_uint32_t*)src;
  for (n = 0; n < count; n++)
    {
