...
/**
 * \file algorithms/geometry/PGASLiteCollRegistration.h
 * \brief Just a few PGAS protocols
 */

#ifndef __algorithms_geometry_PGASLiteCollRegistration_h__
#define __algorithms_geometry_PGASLiteCollRegistration_h__
...
namespace PAMI
{
  ...
  namespace Lite
  {
    ...
    class PGASRegistration :
       public PAMI::CollRegistration::CollRegistration<PAMI::CollRegistration::Lite::PGASRegistration<T_Geometry,
                                                                       T_NI,
                                                                       T_Allocator,
                                                                       T_Protocol1,
                                                                       T_Protocol2,
	...
	typedef PGFactory<xlpgas::ShmHybridPipelinedBcast<T_NI,T_Device_P2P>,T_NI,T_Device_P2P,HybridBroadcastExec> HybridBroadcastFactory;
      ...
      inline PGASRegistration(pami_client_t                        client,
        ...
        CollRegistration<PAMI::CollRegistration::Lite::PGASRegistration<T_Geometry,
                                                                  T_NI,
                                                                  T_Allocator,
                                                                  T_Protocol1,
                                                                  T_Protocol2,
