...
Parser::Parser(bool multiline)
  : _multiline(multiline), _root(0), _xmlstack(), _parser(XML_ParserCreate(0)), 
...
void Parser::_startXML (void *ud, 
  ...
  if (!parser->_rootInitialized) {
    ...
    assert (curr != NULL);
    Serializable * newobject = curr->addSubEntity((const char *)name,
						  (const char **)atts);
...
void Parser::_endXML (void *ud, const XML_Char *name) {
...
// is I (so the attribute name is ATTR_VEC[I] and its value is in
// ATTR_VEC[I+1]

// verify that ATTR_VEC[I] entry corresponds to the desired
// ATTR_NAME and that they are not null

bool XML::verify_attr(const char *className, const char *attrName, const char *attr0, const char *attr1, bool isOptional) {
  assert(attrName != 0);
...
// then ATTR_VEC[I] == 0, so there are not unknown attributes
// in the stream

void XML::verify_last_attr(const char *className, const char *attr0) {
  if (attr0 != 0) {                                      
...
void XML::write_text(std::ostream &os, const char *className, const char *attrName, const std::string& attrValue) {
  os << " " << attrName << "='";
...
void XML::write_cstring(std::ostream &os, const char *className, const char *attrName, const char* attrValue) {
  os << " " << attrName << "='";
...
#ifdef XML_FIXES
void XML::write_binary(std::ostream &os, const char *className, const char *attrName, const std::string& attrValue) {
  os << " " << attrName << "='";
...
void XML::write_binary(std::ostream &os, const char *className, const char *attrName, const char* buf, unsigned buflen) {
  os << " " << attrName << "='";
...
void XML::write_uint32(std::ostream &os, const char *className, const char *attrName, unsigned attrValue) {
  os << " " << attrName << "='" << attrValue << "'";
}

void XML::write_uint64(std::ostream &os, const char *className, const char *attrName, unsigned long long attrValue) {
  os << " " << attrName << "='" << attrValue << "'";
}

void XML::write_uint32h(std::ostream &os, const char *className, const char *attrName, unsigned attrValue) {
  os.fill('0');
  os << " " << attrName << "='0x" << hex << setw(8) << attrValue << dec << "'";
  os.fill(' ');
}

void XML::write_uint16h(std::ostream &os, const char *className, const char *attrName, unsigned short attrValue) {
  os.fill('0');
  os << " " << attrName << "='0x" << hex << setw(4) << attrValue << dec << "'";
  os.fill(' ');
}

void XML::write_uint8h(std::ostream &os, const char *className, const char *attrName, unsigned char attrValue) {
  os.fill('0');
...
void XML::write_int32(std::ostream &os, const char *className, const char *attrName, int attrValue) {
  os << " " << attrName << "='" << attrValue << "'";
}

void XML::write_uint64h(std::ostream &os, const char *className, const char *attrName, unsigned long long attrValue) {
  os.fill('0');
...
void XML::write_uchar(std::ostream &os, const char *className, const char *attrName, unsigned char attrValue) {
  os << " " << attrName << "='" << (unsigned) attrValue << "'";
}

void XML::write_float(std::ostream &os, const char *className, const char *attrName, long double attrValue) {
  os << " " << attrName << "='" << fixed << attrValue << "'";
}


void XML::write_ucharh(std::ostream &os, const char *className, const char *attrName, unsigned char attrValue) {
  os.fill('0');
...
void XML::write_bool(std::ostream &os, const char *class_name, const char *attr_name, bool attr_value) {
  if (attr_value) {
    os << " " << attr_name << "='true'";
  } else {
    os << " " << attr_name << "='false'";
...
// validate that the position matched the desired ATTR_NAME and
// then assign ATTR_VEC[I+1] to result. Increment I so we can
// now process the next attribute

std::string XML::read_text(const char *className, const char *attrName, const char *attr0, const char *attr1, unsigned* i, bool isOptional) {
...
char *XML::get_attrValue(const char *className, const char *attrName, const char *attr0, const char *attr1, unsigned* i, bool isOptional) {
	  if( verify_attr(className, attrName, attr0, attr1, isOptional) )
	  {
		  (*i)+=2;
...
#ifdef XML_FIXES
std::string XML::read_binary(const char *className, const char *attrName, const char *attr0, const char *attr1, unsigned* i, bool isOptional) {
...
void XML::read_binary(const char *className, const char *attrName, const char *attr0, const char *attr1, unsigned* i, bool isOptional, char *buf, unsigned buflen) {
	  if( verify_attr(className, attrName, attr0, attr1, isOptional) )
	  {
		  (*i)+=2;
...
void XML::read_cstring(const char *className, const char *attrName, const char *attr0, const char *attr1, unsigned* i, bool isOptional, char *buf, unsigned buflen) {
	  if( verify_attr(className, attrName, attr0, attr1, isOptional) )
	  {
		  (*i)+=2;
...
unsigned XML::read_uint32(const char *className, const char *attrName, const char *attr0, const char *attr1, unsigned* i, bool isOptional) {
	  if( verify_attr(className, attrName, attr0, attr1, isOptional) )
	  {
		  (*i)+=2;
		  unsigned temp;
...
unsigned long long XML::read_uint64(const char *className, const char *attrName, const char *attr0, const char *attr1, unsigned* i, bool isOptional) {
	  if( verify_attr(className, attrName, attr0, attr1, isOptional) )
	  {
		  (*i)+=2;
...
unsigned XML::read_uint32h(const char *className, const char *attrName, const char *attr0, const char *attr1, unsigned* i, bool isOptional) {
	  if( verify_attr(className, attrName, attr0, attr1, isOptional) )
	  {
		  (*i)+=2;
...
unsigned short XML::read_uint16h(const char *className, const char *attrName, const char *attr0, const char *attr1, unsigned* i, bool isOptional) {
	  if( verify_attr(className, attrName, attr0, attr1, isOptional) )
	  {
		  (*i)+=2;
...
unsigned char XML::read_uint8h(const char *className, const char *attrName, const char *attr0, const char *attr1, unsigned* i, bool isOptional) {
	  if( verify_attr(className, attrName, attr0, attr1, isOptional) )
	  {
		  (*i)+=2;
...
int XML::read_int32(const char *className, const char *attrName, const char *attr0, const char *attr1, unsigned* i, bool isOptional) {
	  if( verify_attr(className, attrName, attr0, attr1, isOptional) )
	  {
		  (*i)+=2;
		  //  unsigned temp;
...
unsigned long long XML::read_uint64h(const char *className, const char *attrName, const char *attr0, const char *attr1, unsigned* i, bool isOptional) {
	  if( verify_attr(className, attrName, attr0, attr1, isOptional) )
	  {
		  (*i)+=2;
		  unsigned long long temp;
...
long double XML::read_float(const char *className, const char *attrName, const char *attr0, const char *attr1, unsigned* i, bool isOptional) {
	  if( verify_attr(className, attrName, attr0, attr1, isOptional) )
	  {
		  (*i)+=2;
		  long double temp;
...
unsigned char XML::read_uchar(const char *className, const char *attrName, const char *attr0, const char *attr1, unsigned* i, bool isOptional) {
	  if( verify_attr(className, attrName, attr0, attr1, isOptional) )
	  {
		  (*i)+=2;
		  unsigned temp;
...
unsigned char XML::read_ucharh(const char *className, const char *attrName, const char *attr0, const char *attr1, unsigned* i, bool isOptional) {
  return XML::read_uchar(className, attrName, attr0, attr1, i, isOptional);
} 


// same as READ_ATTR_TEXT but convert to unsigned char
bool XML::read_bool(const char *className, const char *attrName, const char *attr0, const char *attr1, unsigned* i, bool isOptional) {
	  if( verify_attr(className, attrName, attr0, attr1, isOptional) )
	  {
		  (*i)+=2;
...
void XML::Serializable::write(std::ostream& o) const{ XMLLIB_THROW("write method not implemented"); };

void XML::Serializable::serializeXML(std::ostream& os) const{ XMLLIB_THROW("serializeXML method not implemented"); };

void XML::Serializable::readXML(std::istream &is){ XMLLIB_THROW("readXML method not implemented") };
